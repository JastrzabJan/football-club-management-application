 ...
 * 
 * This implementation searches for {@link pjatk.edu.pl.footballclubmanagementapplication.backend.data.entity.User} entities by the e-mail address
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	/**
	 *
	 * Recovers the {@link pjatk.edu.pl.footballclubmanagementapplication.backend.data.entity.User} from the database using the e-mail address supplied
